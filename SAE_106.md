...
Vous devez réaliser le site Web présentant votre controverse sociotechnique de la [SAÉ 1.06]({{site.baseurl}}/assets/Sae1-6.pdf).
Pour rendre ce site web accessible, vous utiliserez le dossier `public_html` de l'un des membres du groupe comme vu en TD.
La date limite de rendu est le mercredi 12/12 à 23h59. Le rendu se fera sur [l'espace Moodle du cours](https://moodle.umontpellier.fr/course/view.php?id=28316). 

Il faudra rendre dans un dossier compressé :
- les fichiers sources du site (dans une archive .zip),
- un fichier `readme.md` précisant:
   - les membres du groupe, leurs parts d'implication dans le projet,
   - le lien vers votre site web.
   - le lien vers le dépôt gitlab comportant les fichiers sources du site, attention à ajouter votre enseignant en tant que 'developer', vous ajouterez aussi ce fichier `readme.md`.
...
Vous pourrez vous baser sur votre synopsis et votre PESTEL pour le contenu de votre site. Vous pourrez aussi faire un lien vers le fichier de votre podcast. Si besoin, vous pourrez compléter avec du *Lorem Ipsum*.
