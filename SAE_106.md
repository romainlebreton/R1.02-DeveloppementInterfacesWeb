...
La date limite de rendu est le mercredi 04/12 à 23h59. Le rendu se fera sur [l'espace moodle du cours](https://moodle.umontpellier.fr/course/view.php?id=28316). Il faudra rendre dans un dossier compressé:
=======
Pour rendre ce site web accessible, vous utiliserez le dossier `public_html` de l'un des membres du groupe comme vu en TD.
La date limite de rendu est le dimanche 1/12 à 23h59. Le rendu se fera sur [l'espace Moodle du cours](https://moodle.umontpellier.fr/course/view.php?id=28316). Il faudra rendre dans un dossier compressé :
>>>>>>> refs/remotes/origin/gh-pages
- les sources du site,
- un fichier `readme.txt` ou `readme.md` précisant les membres du groupe, leurs parts d'implication dans le projet et le lien vers votre site web.
