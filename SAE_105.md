---
title: Modalités du site de la SAÉ 1.05
...
Vous devez réaliser la page d'accueil du site Web présentant votre escape room de la SAÉ 1.05.
Pour rendre ce site web accessible vous utiliserez le dossier `public_html` de l'un des membres du groupe.
La date limite de rendu est le dimanche 19/10 à 23h59. 
En plus d'héberger le site, il faudra déposer les fichiers dans une archive sur [l'espace moodle du cours](https://moodle.umontpellier.fr/course/view.php?id=28316). Il faudra rendre dans un dossier compressé:
- les sources du site,
- un fichier readme.pdf précisant les membres du groupes, leurs parts d'implication dans le projet et le lien vers votre site web.
