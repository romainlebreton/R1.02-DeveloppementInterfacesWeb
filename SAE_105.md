...
La date limite de rendu est le dimanche 18/10 à 23h59. 
En plus d'héberger le site, il faudra déposer les fichiers en respectant les consignes de M. Chollet (challengeme). Il faudra rendre dans un dossier compressé:
- les sources du site,
